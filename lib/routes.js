...
module.exports = {
	...
	configure: function (app) {
		...
		app.get('/api/getContactListPagination/:skip', function (req, res) {
			security(req, res);
			entity.getContactListPagination(req, res);
		});
		
		app.get('/api/getRecordCountContacts/', function (req, res) {
			security(req, res);
			entity.getRecordCountContacts(req, res);
		});
		...
		app.get('/api/getVoterContactList/', function (req, res) {
			security(req, res);
		...
		app.get('/api/getVoterContactListPagination/:skip', function (req, res) {
			security(req, res);
			entity.getVoterContactListPagination(req, res);
		});
		
		app.get('/api/getRecordCountVoterContacts/', function (req, res) {
			security(req, res);
			entity.getRecordCountVoterContacts(req, res);
		});
